...
---
## 概要 (Overview)
Unreal Engine 5を用いて、約 2ヶ月程で制作した、ノスタルジックな夏の探索アドベンチャーゲームです。夏休みの最後の3日間、プレイヤーは小さな田舎町を舞台に、NPCとの交流を通じて「忘れられた約束」の謎を解き明かしていきます。
...
- **新規ゲームプレイシステムの追加: 昆虫採集**
  ...
  - **実装計画:**
    ...
    - 捕まえた昆虫を記録する「図鑑」UI (`WBP_Insect_Book`) を作成。
