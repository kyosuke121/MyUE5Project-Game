...
| **開発期間** | 約 2ヶ月 (2025年 6月 1日 ～ 8月 16 日)現在 |
...
- **一日の終わりを告げる自動就寝イベント:**
  - 最終日を除く毎日の特定時刻（21:00）になると、強制的に就寝イベントがトリガーされます。
  - `Disable Input`によるプレイヤー操作の無効化、`Camera Fade`による演出を挟み、次の日の朝まで時間を進めます。
  - このシステムにより、物語に明確な「1日」という区切りが生まれ、プレイヤーは限られた時間の中で探索と交流を行うという、計画的なプレイが促されます。
